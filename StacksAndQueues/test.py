...
# {email, phone}❌
# {ht_number, name, dob}✅
# {ht_number, name, email}✅
# {ht_number, name, phone}✅
# {ht_number, dob, email}✅
# {ht_number, dob, phone}✅
# {ht_number, email, phone}✅
# {name, dob, email}❌
# {name, dob, phone}❌
# {name, email, phone}❌
# {dob, email, phone}❌
# {ht_number, name, dob, email}✅
# {ht_number, name, dob, phone}✅
# {ht_number, name, email, phone}✅
# {ht_number, dob, email, phone}✅
# {name, dob, email, phone}❌
# {ht_number, name, dob, email, phone}✅


# Candidate keys --> {ht_number}✅ {email}❌ {phone}❌
