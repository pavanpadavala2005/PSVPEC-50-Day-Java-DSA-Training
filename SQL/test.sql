...
1. CREATE :-
    ...
    CREATE TABLE <table_name>(
        col1 <d_type> <CONSTRAINT>,
        col2 <d_type> <CONSTRAINT>,
        col3 <d_type> <CONSTRAINT>,
        col4 <d_type> <CONSTRAINT>
    );
    ...
    CREATE TABLE Student(
        ...
        email VARCHAR(30)  UNIQUE CHECK(email != NULL),
        phone_number VARCHAR(10)

        CONSTRAINT student_belongs_to
            FOREIGN KEY  (dept_id)
    ...
    ALTER TABLE <table_name> 
        {ADD/DROP/RENAME} COLUMN {properties}
    
    ALTER TABLE Student 
        ADD COLUMN yop INT CHECK(yop > 2026);
    
    ALTER TABLE Student
        DROP COLUMN yop;

    ALTER TABLE Student
        RENAME COLUMN yop to year_of_pass;
...
INSERT INTO student (ht_number, name, gender, dob, email, phone_number, cgpa, 

, dept_id, dept_name, yop, academic_fee, blood_group, college_name, pin_code, nationality,   ) 
VALUES 
...
INSERT INTO emoloyee (emp_id, emp_name, gender, email, phone_number, experience, salary, increment, role, rating, dept_id, dept_name, shift_time, project_name, project_deadline, levae_count, is_permenant, company_name, nationality, state) 
VALUES 
