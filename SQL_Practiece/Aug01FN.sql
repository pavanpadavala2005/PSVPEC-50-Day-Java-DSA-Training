-- =================================================================================================
-- EMPLOYEE SQL PRACTICE DATASET
-- =================================================================================================
-- Purpose : SQL practice for employee, company, department, salary and project analysis.
-- Records : 250 employees
-- Departments : 101 - 110
-- =================================================================================================
...
INSERT INTO employee (
    emp_id, emp_name, gender, email, phone_number, experience, salary, increment,
    role, rating, dept_id, dept_name, shift_time, project_name, project_deadline,
    leave_count, is_permanent, company_name, nationality, state
)
VALUES 
...
-- =================================================================================================
-- Total Questions: 30
-- Topics: WHERE, GROUP BY, HAVING, ORDER BY, Aggregate Functions, DISTINCT, Date Functions,
--         CASE, Subqueries, Conditional Aggregation and Multi-column Analysis.
-- =================================================================================================

-- 1. Find the number of male and female employees in every company.
-- 2. Find the total salary expenditure for each department in every company.
-- 3. Find the total salary expenditure for Day-shift and Night-shift employees in every company.
-- 4. Find the total salary expenditure on Indian employees in every company.
-- 5. Find the maximum increment percentage received by male and female employees in every company.
-- 6. Find the number of temporary employees in every department of every company.
-- 7. Find the maximum salary paid to a temporary employee working the Night shift in every company.
-- 8. Find the count of non-permanent employees having the maximum experience in every company.
-- 9. Find all projects whose deadline falls in the year 2027 in every company.
-- 10. Find the maximum salary in each department of every company.
-- 11. Find the total number of employees in every company.
-- 12. Find the average salary of employees in every company.
-- 13. Find the maximum and minimum salary in every company.
-- 14. Find the average salary of Day-shift and Night-shift employees in every company.
-- 15. Find the average experience of permanent employees in every company.
-- 16. Find the number of permanent and non-permanent employees in every company.
-- 17. Find the number of employees with a rating of 5 in every company.
-- 18. Find the number of employees having more than 5 years of experience in every department.
-- 19. Find the average increment percentage in each department of every company.
-- 20. Find the total salary expenditure for each nationality in every company.
-- 21. Find the number of employees in each state.
-- 22. Find the number of employees whose leave count is greater than 3 in every company.
-- 23. Find the company-wise maximum and minimum project deadlines.
-- 24. Find the number of projects ending in 2027 for each company.
-- 25. Find the department having the highest average employee experience in every company.
-- 26. Find the company with the highest total salary expenditure.
-- 27. Find the second-highest salary in every company.
-- 28. Find employees whose salary is greater than the average salary of their company.
-- 29. Find the highest-paid employee in each department of every company.
-- 30. Find the departments where the average salary is greater than 100000.
