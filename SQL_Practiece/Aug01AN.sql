...
INSERT INTO student (
    ht_number, name, gender, dob, email, phone_number,
    cgpa, attendance_percentage, dept_id, dept_name, yop,
    academic_fee, blood_group, college_name, pin_code,
    nationality, state
) VALUES
...
## 3. SQL Practice Questions

### Basic Filtering & Projection

1. Retrieve the `ht_number`, `name`, `gender`, and `cgpa` of all students.
2. Retrieve `ht_number` and `name` of all female students whose `cgpa` is greater than 9.0.
3. Retrieve all students from `Tamil Nadu` who studied at `PSVPCE`.
4. Retrieve `ht_number`, `name`, `college_name`, and `dob` of Indian students born in 2005.
5. Retrieve all students whose email address uses the `@yahoo.com` domain.
6. Retrieve `ht_number`, `name`, `college_name`, and `yop` of students whose `yop` is 2024.
7. Retrieve all students whose nationality is not `Indian`.
8. Retrieve the postal codes of students whose nationality is `Australian`.
9. Retrieve the distinct state names of Indian students.
10. Retrieve all students whose attendance is between 60% and 80%, inclusive.
11. Retrieve all students whose CGPA is between 8.0 and 9.0, inclusive.
12. Retrieve all students from the `CSE`, `ECE`, or `IT` departments using a single condition.
13. Retrieve the names and email addresses of students whose names start with `S`.
14. Retrieve the top 10 students with the highest CGPA.
15. Retrieve all students whose name contains the letter `a`, ignoring case if your MySQL collation is case-insensitive.
16. Retrieve `ht_number`, `name`, `college_name`, and `academic_fee` for students whose academic fee is greater than 200000.
17. Retrieve all female students from Tamil Nadu who have attendance of at least 85%.
18. Display students ordered first by department name and then by CGPA from highest to lowest.

### Aggregation & Grouping

19. Find the student(s) with the maximum CGPA in `PSVPCE`.
20. Find the student(s) paying the minimum academic fee in `MIT`.
21. Count students with CGPA greater than 8.5 who are from outside India.
22. Find the department-wise student count in `PSVPCE`.
23. Find the maximum CGPA for each nationality and display the corresponding nationality.
24. Count students from each college whose attendance is below 65%.
25. Find the minimum attendance percentage in every college.
26. Count students by blood group among Indian students.
27. Find the average CGPA of students in each department.
28. Find the average academic fee for each college.
29. Find the total academic fee collected from students of each department.
30. Find colleges having more than 5 students.
31. Find departments whose average CGPA is greater than 8.0.
32. Find the highest and lowest attendance percentage in each department.
33. Find the number of male and female students in each department.
34. Find the average CGPA separately for Indian and non-Indian students.
35. Find the total number of students for each nationality, ordered from highest to lowest.

### Additional SQL Practice — 20 More Questions

36. Find the second-highest CGPA in the entire student table.
37. Find the student(s) whose CGPA is equal to the overall average CGPA.
38. Find the student(s) with the highest attendance in each department.
39. Find the student(s) paying the highest academic fee in each college.
40. Find the number of students graduating in each year (`yop`).
41. Find the average CGPA of students graduating in 2025, 2026, and 2027.
42. Find colleges where the average attendance is greater than 75%.
43. Find departments where the minimum attendance is below 50%.
44. Find the total academic fee paid by Indian students and non-Indian students separately.
45. Find the difference between the highest and lowest CGPA in each department.
46. Find the number of students whose CGPA is higher than their department's average CGPA.
47. Find students whose CGPA is higher than the overall average CGPA and attendance is at least 80%.
48. Find the college with the highest average CGPA.
49. Find the nationality with the highest average academic fee.
50. Find the department with the largest total academic fee.
51. Find students who belong to the same college as `Aarav Kumar`.
52. Find students who have the same CGPA as `Swathi Mohan`.
53. Find the latest-born student in each department using `dob`.
54. Find the number of students for each combination of `dept_name` and `gender`.
55. Find the percentage of students from each department who have attendance of at least 75%.
